...
public class Practice12PathEffectView extends View {
...

    {
        ...
        discretePathEffect = new DiscretePathEffect(15, 5);
        dashPathEffect = new DashPathEffect(new float[]{10, 5, 2, 5}, 30);

        RectF leftRectF = new RectF(10, 10, 30, 30);
        Path dashPath = new Path();
        dashPath.addArc(leftRectF, -225, 225);
        pathDashPathEffect = new PathDashPathEffect(dashPath, 20, 0, PathDashPathEffect.Style.ROTATE);
