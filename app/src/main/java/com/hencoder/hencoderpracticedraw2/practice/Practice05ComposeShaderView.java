...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Shader logoShader = new BitmapShader(logo, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        ComposeShader composeShader = new ComposeShader(batmanShader, logoShader, PorterDuff.Mode.DST_IN);
